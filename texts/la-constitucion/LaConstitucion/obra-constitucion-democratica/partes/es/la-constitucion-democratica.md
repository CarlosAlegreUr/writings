...
# Parte 0: Introducción para el lector
...
## Qué vas a encontrar {.unnumbered}
...
- **Parte 1** — Texto constitucional completo (72 artículos, 6 títulos).
- **Parte 2** — Argumentación y filosofía de cada decisión de diseño.
- **Parte 3** — Conclusión y referencias.
...
- **TÍTULO II:** SISTEMA ELECTORAL (Arts. 10-17)
- **TÍTULO III:** PROCESO DE TRANSICIÓN (Arts. 18-19)
- **TÍTULO IV:** SEPARACIÓN Y CONTRAPESOS DE LOS PODERES (Arts. 20-65)
  - Subtítulo 1: Poder Legislativo (Arts. 21-23)
  - Subtítulo 2: Poder Ejecutivo (Arts. 24-31)
  - Subtítulo 3: Poder Judicial (Arts. 32-38)
  - Subtítulo 4: Equilibrio entre Poderes (Arts. 39-41)
  - Subtítulo 5: Control de Legitimidad Judicial (Arts. 42-45)
  - Subtítulo 6: Anulación Popular (Art. 46)
  - Subtítulo 7: Control Fiscal y Transparencia (Arts. 47-48)
  - Subtítulo 8: Fuerzas Armadas (Arts. 49-54)
  - Subtítulo 9: Estados de Excepción (Arts. 55-65)
- **TÍTULO V:** REFORMA Y PROTECCIÓN CONSTITUCIONAL (Arts. 66-70)
- **TÍTULO VI:** DERECHOS Y PROTECCIONES (Arts. 71-72)

---
---

## TÍTULO I: PRINCIPIOS FUNDAMENTALES {.unnumbered}
...
### Artículo 2: Niveles de Consenso {.unnumbered}
...
### Artículo 3: Sujetos Constitucionales {.unnumbered}
...
### Artículo 4: Sufragio Universal {.unnumbered}
...
### Artículo 5: Secreto y Verificabilidad del Voto {.unnumbered}
...
### Artículo 6: Garantía de Anulación Popular {.unnumbered}
...
### Artículo 7: Derecho a la Autodeterminación Territorial {.unnumbered}
...
### Artículo 8: Igualdad ante la Ley y Responsabilidad Pública {.unnumbered}
...
### Artículo 9: Lengua Oficial {.unnumbered}
...
## TÍTULO II: SISTEMA ELECTORAL {.unnumbered}

### Artículo 10: Representación por Distritos Territoriales {.unnumbered}
...
### Artículo 11: Revocabilidad de Representantes {.unnumbered}
...
### Artículo 12: Procedimiento de Revocación {.unnumbered}
...
### Artículo 13: Sistema de Doble Vuelta Electoral en Distritos {.unnumbered}
...
### Artículo 14: Tamaño de Distritos {.unnumbered}
...
### Artículo 15: Actualización Distrital Periódica {.unnumbered}
...
### Artículo 17: Voto Remoto Verificable {.unnumbered}
...
## TÍTULO III: PROCESO DE TRANSICIÓN {.unnumbered}

### Artículo 18: Transición Institucional {.unnumbered}

El Proceso de Transición comienza inmediatamente tras la aprobación de esta Constitución y finaliza cuando el Presidente electo conforme al artículo 24 toma posesión del cargo. Durante este periodo, el régimen anterior a la entrada en vigor de esta Constitución continúa gobernando con carácter interino, ejerciendo exclusivamente funciones ejecutivas y sometido a los principios y normas de esta Constitución.

El régimen anterior publica el resultado del Algoritmo de Optimización de la Corruptibilidad de Distritos conforme al artículo 14, junto con todos los datos utilizados para su ejecución, de manera que cualquier ciudadano pueda verificar el resultado, en un plazo máximo de 3 semanas desde la aprobación de esta Constitución. Tras la publicación y formación de distritos, se convocan elecciones en el siguiente orden, cada una en un mes distinto y consecutivo: primero, elecciones al Poder Legislativo conforme al artículo 13; segundo, elecciones al Poder Ejecutivo conforme al artículo 24.

Si durante el Proceso de Transición se declara un estado de excepción conforme al artículo 55, el régimen anterior asume el control hasta el cese del estado de excepción, siempre bajo los principios de esta Constitución. Tras el cese, el Proceso de Transición se reanuda desde el punto en que fue interrumpido. Esta regla se aplica recursivamente: si se declara un nuevo estado de excepción durante el Proceso de Transición reanudado, se aplica el mismo mecanismo.

---

### Artículo 19: Proceso de Arranque - Mandato Especial {.unnumbered}

El Proceso de Arranque es el periodo de 1 año inmediatamente posterior a la finalización del Proceso de Transición (artículo 18). Esta duración de 1 año no puede modificarse durante el propio Proceso de Arranque. Durante este periodo, ciertos niveles de consenso requeridos por esta Constitución son reducidos conforme se especifica en cada artículo correspondiente.

Si durante el Proceso de Arranque se declara un estado de excepción conforme al artículo 55, el Proceso de Arranque se suspende durante la duración del estado de excepción. Tras el cese, el Proceso de Arranque se reanuda con el tiempo restante que quedaba el día anterior a la declaración del estado de excepción, con un mínimo de 2 meses. Esta regla se aplica recursivamente: si se declara un nuevo estado de excepción durante el Arranque reanudado, se aplica el mismo mecanismo.
...
## TÍTULO IV: SEPARACIÓN Y CONTRAPESOS DE LOS PODERES {.unnumbered}

### Artículo 20: Separación de Poderes {.unnumbered}
...
## SUBTÍTULO 1: PODER LEGISLATIVO {.unnumbered}

### Artículo 21: Poder Legislativo - Composición {.unnumbered}

El Poder Legislativo se compone de una cámara única de representantes elegidos por distritos territoriales conforme al artículo 10. Los representantes son elegidos por mandato de 4 años y son revocables directamente por el pueblo de su distrito conforme a los artículos 11 y 12.

---

### Artículo 22: Poder Legislativo - Funciones {.unnumbered}

El Poder Legislativo ejercerá el monopolio de la función legislativa salvo en las excepciones previstas en esta Constitución, sin perjuicio del control de constitucionalidad ejercido por el Poder Judicial conforme a los artículos 42 y 43. Sus funciones incluyen:
...
### Artículo 23: Poder Legislativo - Votaciones {.unnumbered}
...
## SUBTÍTULO 2: PODER EJECUTIVO {.unnumbered}

### Artículo 24: Poder Ejecutivo - Presidente {.unnumbered}
...
### Artículo 25: Poder Ejecutivo - Funciones del Presidente {.unnumbered}

El Presidente ejerce la totalidad del Poder Ejecutivo. Sus funciones incluyen:

1. Jefatura del Estado.
2. Defensa nacional y mando de las Fuerzas Armadas (artículo 49).
3. Relaciones exteriores y representación internacional.
4. Declaración de estados de excepción (artículo 55).
...
### Artículo 26: Sucesión Presidencial {.unnumbered}
...
### Artículo 27: Incapacidad Presidencial {.unnumbered}
...
### Artículo 28: Ministerios - Límite Constitucional {.unnumbered}

El número máximo de ministerios por defecto es de 20. La estructura ministerial es competencia exclusiva del Presidente conforme al artículo 25. Esta Constitución no establece una lista cerrada de ministerios, solo el número máximo de estos.

Durante el Proceso de Arranque, este límite puede modificarse con consenso de Nivel N1.

---

### Artículo 29: Ministerios - Nombramiento {.unnumbered}
...
### Artículo 30: Presupuesto Anterior por Defecto {.unnumbered}
...
### Artículo 31: Límite Presupuestario del Ejecutivo {.unnumbered}
...
## SUBTÍTULO 3: PODER JUDICIAL {.unnumbered}

### Artículo 32: Poder Judicial - Independencia y Financiación {.unnumbered}
...
### Artículo 33: Poder Judicial - Jerarquía {.unnumbered}
...
### Artículo 34: Derecho de Apelación y Casación {.unnumbered}
...
Cuando esta Constitución establezca que una decisión del Tribunal Supremo es recurrible, la apelación es resuelta por un magistrado distinto del mismo Tribunal. El magistrado que emitió la decisión apelada no puede participar en la resolución de la apelación. El magistrado asignado se selecciona mediante un mecanismo aleatorio determinista. El procedimiento por defecto es el siguiente: se aplica una función hash criptográfica a los datos biométricos del apelante. El dato biométrico se selecciona según la siguiente prioridad: huella dactilar de la mano izquierda (del meñique al pulgar), de la mano derecha (del pulgar al meñique), del pie izquierdo (del meñique al pulgar), del pie derecho (del pulgar al meñique), retina del ojo izquierdo, retina del ojo derecho. Se utiliza el primer dato disponible. Si ninguno de estos datos biométricos está disponible, se utilizan los del magistrado que emitió la decisión apelada. Los magistrados se ordenan por antigüedad en el cargo siendo el de mayor antigüedad el primero. El resultado de aplicar la operación módulo del número de magistrados al resultado del hash determina el índice del magistrado asignado conforme al orden de antigüedad establecido. Si el resultado señala al magistrado que emitió la decisión apelada, se incrementa en uno y se aplica el módulo de nuevo. El método de asignación puede modificarse durante el Proceso de Arranque mediante consenso de Nivel N1, siempre que el método alternativo sea determinista, no manipulable y públicamente verificable.

El número total de apelaciones y casaciones en un mismo caso no puede superar 5.

---

### Artículo 35: Nombramiento de Jueces - Principio {.unnumbered}
...
### Artículo 36: Tribunal Supremo - Composición {.unnumbered}
...
### Artículo 37: Tribunal Supremo - Nombramiento {.unnumbered}
...
## SUBTÍTULO 4: EQUILIBRIO ENTRE PODERES {.unnumbered}

### Artículo 39: Autodestrucción Mutua - Mecanismo {.unnumbered}
...
### Artículo 40: Autodestrucción Mutua - Periodo de Desactivación {.unnumbered}
...
### Artículo 41: Incumplimiento Grave del Presidente {.unnumbered}
...
Resolución:
El Tribunal Supremo resuelve directamente el proceso y determina si el incumplimiento constituye alguna de las causas establecidas en este artículo. La decisión del Tribunal Supremo es recurrible una única vez mediante apelación (artículo 34) por cualquier ciudadano con derecho a voto.
...
## SUBTÍTULO 5: CONTROL DE LEGITIMIDAD JUDICIAL {.unnumbered}

### Artículo 42: Supremacía Constitucional {.unnumbered}
...
### Artículo 43: Proceso De Análisis De Constitucionalidad {.unnumbered}

Cualquier ciudadano con derecho a voto puede impugnar ante los tribunales la constitucionalidad de cualquier ley aprobada, independientemente de cuánto tiempo haya transcurrido desde su aprobación. Cada ley puede ser sometida a revisión constitucional una vez cada 6 años, contados desde la presentación de la impugnación. Cada ciudadano puede presentar una impugnación o un grupo de impugnaciones una vez cada 4 meses. Las impugnaciones pueden presentarse individualmente o en grupos de hasta 10 leyes, con veredicto independiente para cada ley del grupo. Solo puede existir un proceso de revisión constitucional activo por ley en cada momento; si un paquete contiene una ley ya en proceso, el paquete se admite pero esa ley se excluye. El máximo de grupos en proceso simultáneo es de 10, lo que establece un límite de 100 leyes en revisión constitucional simultánea. La impugnación se presenta ante tribunal de primera instancia y se resuelve conforme al siguiente sistema en capas:

1. Primera Instancia: El tribunal puede declarar inaplicable una norma que considere contraria a esta Constitución. Esta declaración tiene efecto únicamente para el caso concreto. El tribunal debe fundamentar detalladamente las razones por las cuales considera que la norma contraviene la Constitución. Cualquier ciudadano con derecho a voto puede recurrir esta decisión ante segunda instancia dentro de un plazo máximo de 2 semanas desde la decisión de primera instancia, independientemente de su participación en el proceso inicial. Transcurrido este plazo sin recurso, la decisión de primera instancia deviene firme.
...
El derecho de recurso se ejerce conforme al artículo 34: por caso y por nivel. Cuando varias partes impugnan la constitucionalidad de la misma norma ante el mismo nivel, tiene prioridad la impugnación presentada en primer lugar; las demás se incorporan al proceso ya iniciado. El caso asciende una única vez, no una vez por cada impugnación.

Los parámetros numéricos de este artículo (6 años entre revisiones, 10 leyes por grupo, 10 grupos simultáneos, 2 semanas de plazo de recurso, 4 meses de espera por ciudadano) pueden modificarse mediante consenso de Nivel N5.

---

### Artículo 44: Responsabilidades Penales Derivadas del Proceso de Constitucionalidad {.unnumbered}
...
## SUBTÍTULO 6: ANULACIÓN POPULAR {.unnumbered}

### Artículo 46: Anulación Popular de Decisiones Judiciales {.unnumbered}
...
Cuando la anulación popular alcanza el umbral establecido:
...
## SUBTÍTULO 7: CONTROL FISCAL Y TRANSPARENCIA {.unnumbered}

### Artículo 47: Transparencia Presupuestaria {.unnumbered}
...
Cualquier ciudadano o persona con residencia fiscal en el país puede consultar esta información gratuitamente. La transparencia presupuestaria no admite excepciones salvo las establecidas expresamente en el artículo 53.

---

### Artículo 48: Auditoría Pública {.unnumbered}
...
## SUBTÍTULO 8: FUERZAS ARMADAS {.unnumbered}

### Artículo 49: Comandante en Jefe {.unnumbered}
...
### Artículo 50: Declaración de Guerra {.unnumbered}

La declaración de guerra es propuesta por el Presidente y requiere la aprobación del Poder Legislativo mediante consenso de Nivel N5. La defensa inmediata ante ataque o invasión no requiere declaración de guerra previa (artículo 51). La declaración de guerra puede revocarse por iniciativa del Presidente o del Poder Legislativo, siempre que el territorio nacional no se encuentre bajo ataque. En ambos casos, la revocación requiere la aprobación del Poder Legislativo mediante consenso de Nivel N3.

---

### Artículo 51: Operaciones Militares sin Declaración de Guerra {.unnumbered}
...
### Artículo 52: Rendición de Cuentas por Operaciones Secretas {.unnumbered}
...
### Artículo 53: Presupuesto Militar {.unnumbered}
...
### Artículo 54: Separación de Fuerzas {.unnumbered}
...
## SUBTÍTULO 9: ESTADOS DE EXCEPCIÓN {.unnumbered}

### Artículo 55: Estados de Excepción - Principio {.unnumbered}
...
### Artículo 56: Tipos de Estados de Excepción {.unnumbered}
...
- Declaración: Consenso N1 del Legislativo, con prioridad absoluta en agenda. En caso de peligro inminente para la vida, se activa automáticamente.
- Derechos restringibles: Definidos en el Proceso de Arranque.
...
### Artículo 57: Configurabilidad de los Estados de Excepción {.unnumbered}
...
### Artículo 58: Límite 1 - Límite Temporal {.unnumbered}
...
Si la condición persiste, el Legislativo debe pronunciarse obligatoriamente sobre la continuación del estado de excepción a los 6 meses desde su activación. A partir de entonces, la renovación sigue el siguiente esquema de consenso creciente e intervalos decrecientes:

- Primera renovación (a los 6 meses): Consenso de Nivel N1. Siguiente revisión en 2 meses.
- Segunda renovación: Consenso de Nivel N2. Siguiente revisión en 1 mes.
- Tercera renovación: Consenso de Nivel N3. Siguiente revisión en 1 mes.
- Cuarta renovación: Consenso de Nivel N4. Siguiente revisión en 1 mes.
- Quinta renovación y sucesivas: Consenso de Nivel N5. Revisión cada 2 semanas.

Si en cualquier renovación no se alcanza el consenso requerido, el estado de excepción cesa automáticamente.

---

### Artículo 59: Límite 2 - Límite Territorial {.unnumbered}
...
### Artículo 60: Límite 3 - Límite Material y Prohibición de Decretos {.unnumbered}
...
### Artículo 61: Límite 4 - Control Parlamentario {.unnumbered}
...
### Artículo 62: Límite 5 - Control Judicial {.unnumbered}
...
### Artículo 63: Límite 6 - Prohibiciones Absolutas {.unnumbered}
...
Cualquier acto que viole estas prohibiciones es nulo de pleno derecho, sin necesidad de declaración judicial.

---

### Artículo 64: Rendición de Cuentas Post-Excepción {.unnumbered}
...
### Artículo 65: Finalización Automática del Estado de Excepción {.unnumbered}
...
## TÍTULO V: REFORMA Y PROTECCIÓN CONSTITUCIONAL {.unnumbered}

### Artículo 66: Cláusulas Pétreas - Núcleo Intangible {.unnumbered}
...
### Artículo 67: Procedimiento de Reforma de Cláusulas Pétreas {.unnumbered}
...
### Artículo 68: Derecho de Reforma Ordinaria {.unnumbered}
...
### Artículo 69: Iniciativa de Reforma Ordinaria {.unnumbered}
...
### Artículo 70: Supremacía de los Mecanismos Constitucionales {.unnumbered}
...
## TÍTULO VI: DERECHOS Y PROTECCIONES {.unnumbered}

### Artículo 71: Derechos Fundamentales del Sistema Democrático {.unnumbered}
...
### Artículo 72: Derechos Fundamentales Complementarios {.unnumbered}
...
## FIN DE LA CONSTITUCIÓN DEMOCRÁTICA {.unnumbered}
...
#### La democracia produce el bucle de retroalimentación más rico

Todo progreso humano se basa en bucles de retroalimentación: actuar, observar el resultado, corregir, volver a actuar. Aprendemos así. La ciencia funciona así. La evolución funciona así.

En una dictadura, el bucle de retroalimentación es pobre: una persona decide, y la información sobre si esa decisión fue buena o mala llega filtrada, tarde y distorsionada por miedo. En una oligarquía, el bucle es algo más rico pero sigue limitado al grupo en el poder. En democracia, el bucle incluye a toda la sociedad: millones de personas evaluando decisiones, proponiendo alternativas, corrigiendo errores. Cuantas más perspectivas diversas participan en el bucle, mejor se entiende la realidad y mejor se puede llegar a responder a ella.

#### La democracia refleja la biología humana

El cerebro humano no puede procesar toda la información que recibe. Su solución es fijar algunas variables (creencias, hábitos, certezas) mientras varía otras (exploración, prueba y error). Las variables fijas dan estabilidad; las variables libres dan adaptabilidad.

Todo sistema de poder replica este mecanismo a escala social: las leyes son las variables fijas (estabilidad y previsibilidad) y los mecanismos de cambio político son las variables libres (adaptación). Esto es así en dictaduras, oligarquías y democracias por igual. La diferencia es la riqueza con la que cada sistema permite ejercer la parte dinámica.

En una dictadura, las variables las cambia una persona. En una oligarquía, un grupo reducido. En democracia, las elecciones periódicas permiten que toda la sociedad participe en decidir qué variables fijas ya no funcionan y deben cambiar, y la revocabilidad añade un mecanismo de emergencia cuando el cambio no puede esperar al siguiente ciclo. Por el mismo argumento del bucle de retroalimentación anterior: cuantas más perspectivas diversas participan en el proceso de fijar y desfijar variables, más rico es el resultado. La democracia es el sistema que mejor conecta la estabilidad estática que necesita nuestra naturaleza con la dinamicidad que permite la adaptación.

#### La descentralización minimiza el abuso

Todo poder, dado el tiempo suficiente, tiende al abuso. Esto no es cinismo: es una observación empírica constante a lo largo de la historia humana y en los sistemas de ciberseguridad informática, diseñados y operados por humanos. La pregunta no es "¿abusarán?" sino "¿cuánto daño pueden hacer cuando abusen, y cómo minimizar el daño hecho y repararlo lo máximo posible si consiguen abusar?".

La respuesta depende de cuánto poder concentra cada individuo. En una dictadura, un solo individuo concentra todo: el daño potencial es máximo. En democracia, el poder está distribuido entre muchos actores independientes: legisladores de distrito, un ejecutivo separado, un judicial independiente, y un pueblo con capacidad de intervención directa. El daño que puede hacer cualquier actor individual o grupo es limitado por los demás. No se elimina el abuso, el abuso es un fenómeno natural humano; se minimiza su alcance e impacto de forma sistemática.

#### La complejidad siempre creciente hace inevitable la democracia

Este es el argumento de la complejidad siempre creciente de la sabiduría humana. Cada generación hereda el conocimiento acumulado de las anteriores y le añade el suyo. La complejidad de las sociedades humanas no para de crecer: más tecnología, más interconexión, más variables que gestionar. Un protocolo centralizado que funcionaba para una aldea de 500 personas no funciona para una ciudad de 5 millones. Un protocolo que funcionaba en el siglo XVIII no funciona en el siglo XXI.

Los sistemas centralizados y estáticos tienen un techo de complejidad que pueden gestionar. Cuando la sociedad supera ese techo, el sistema se fractura: en forma de violencia, de miseria silenciosa, de presión social insostenible. La democracia, al distribuir la toma de decisiones y permitir la renovación periódica, tiene un techo de complejidad más alto. No es infinito, pero es significativamente superior.

Dicho de otro modo: aunque sistemas más centralizados puedan ser la solución temporal que funciona ahora y funcionó en el pasado, tarde o temprano dejan de funcionar. La complejidad creciente del conocimiento humano es una maldición (o una bendición) que empuja inevitablemente hacia protocolos más descentralizados y dinámicos que sean capaces de manejar todas las variables de forma más adaptativa.

#### La separación de poderes previene la deriva natural hacia la tiranía
...
#### La democracia habilita la especialización

En un sistema centralizado, el gobernante debe ser simultáneamente experto en economía, defensa, sanidad, educación, infraestructura y diplomacia. Nadie lo es. En democracia, la separación de funciones permite que aparezcan especialistas en gestión regional (representantes de distrito) junto a especialistas técnicos (ministerios, agencias, empresas y organizaciones privadas). Cada uno puede hacer bien lo suyo porque no tiene que hacerlo todo. Es el principio de separación de responsabilidades mejorando la producción de un producto aplicado al gobierno.

### En contra

#### Darle una pistola a un mono

El argumento más fuerte contra la democracia es también el más incómodo: la descentralización y el dinamismo solo funcionan bien si se otorgan a individuos con capacidad suficiente para gestionarlos. Dar poder de decisión sobre sistemas complejos a personas que no comprenden esos sistemas produce malas decisiones. Es, en términos crudos, como darle una pistola a un mono.

Este no es un argumento elitista: es una observación sobre la relación entre complejidad y capacidad cognitiva. Un votante que no entiende cómo funciona el sistema fiscal no puede evaluar racionalmente propuestas fiscales. Un votante que no entiende geopolítica no puede evaluar acertadamente, es decir conforme a sus intereses, decisiones de política exterior. La democracia asume que la agregación de millones de decisiones parcialmente informadas produce un resultado razonable. A veces lo produce. A veces no.

#### La democracia es más difícil de diseñar que cualquier otro sistema

Diseñar una constitución democrática funcional es una tarea de complejidad extraordinaria. Una dictadura no necesita preocuparse profundamente por diseño de incentivos, equilibrios de poder, redacción sin ambigüedades ni mecanismos de autocorrección. Una democracia sí. Una democracia mal diseñada colapsa naturalmente en oligarquía o dictadura, porque los actores con más recursos acaban explotando las debilidades del diseño.

La paradoja es que el sistema que más inteligencia requiere para su diseño es precisamente el que otorga poder a personas que pueden no tener esa inteligencia. Una dictadura es fácil de diseñar y difícil de vivir. Una democracia es difícil de diseñar y, si se diseña bien, menos difícil de vivir.

#### El problema de las verdades simplificadas

A medida que las sociedades crecen, ningún individuo puede conocer todo lo suficientemente bien. La gente demanda explicaciones simples para realidades complejas. Los políticos lo saben y explotan esta demanda: simplifican, polarizan, reducen problemas multidimensionales a eslóganes de una frase. Los ciudadanos se alinean con la simplificación que más les reconforta, no con la que mejor describe la realidad o la que mejor solucione un problema. Esto genera un ciclo vicioso: cuanto más simplifican los políticos, más se polariza la sociedad, más se amplía la brecha entre gobernantes y gobernados, y peor funciona la democracia.
...
#### La tendencia oligárquica es inherente al humano
...
La teoría de grafos ofrece una explicación estructural de por qué. Si se modela una sociedad como un grafo donde cada persona es un nodo y cada relación es una arista, el número de relaciones posibles crece combinatoriamente. El caso más simple: con 3 personas (A, B y C) hay exactamente 3 relaciones posibles: A con B, B con C, y C con A. Parece manejable. Pero con 10 personas hay 45 relaciones. Con 100 hay 4.950. Con 1.000 hay casi 500.000. Y las alianzas posibles (subgrupos de 2 o más personas que pueden formarse) crecen aún más rápido. Ningún cerebro humano puede procesar esa cantidad de relaciones simultáneamente. El resultado es que, a medida que un grupo crece, sus miembros necesitan simplificar: delegar, concentrar decisiones, crear jerarquías. No por maldad ni por diseño defectuoso, sino porque la complejidad combinatoria supera los límites cognitivos del individuo. La tendencia oligárquica no es un fallo de la democracia; es una consecuencia de los límites biológicos del cerebro humano operando en grupos grandes.

#### Ningún sistema político resuelve problemas entre Estados

La democracia funciona dentro de un Estado porque existe un marco legal compartido, un monopolio de la violencia y un sistema judicial que arbitra conflictos. Entre Estados, nada de esto existe. No hay juez mundial, no hay ley internacional con dientes, no hay policía que la haga cumplir. La democracia interna no protege contra la agresión externa de un Estado más poderoso que no respete acuerdos. Los mecanismos democráticos tienen un perímetro: las fronteras del Estado.

De nuevo, este no es un problema exclusivo de la democracia: ningún sistema político —dictadura, oligarquía ni democracia— resuelve por sí solo las relaciones entre Estados soberanos. Pero conviene mencionarlo para no atribuir a la democracia capacidades que no tiene.
...
La democracia es, en última instancia, un destino: no porque sea inevitable en cada momento y lugar, sino porque la dirección natural de la complejidad humana en sociedades prósperas apunta hacia ella y la acaba requiriendo. Las sociedades que no lleguen a ella sufrirán más presión, más fricción y más violencia que las que sí lo hagan. No es una promesa de paraíso. Es la constatación de que, entre todos los protocolos de poder disponibles, este es el que menos mal funciona a largo plazo.

Con esta definición, estos argumentos y estas limitaciones en mente, es hora de entrar en los detalles. Lo que sigue es la explicación de cómo cada artículo de esta Constitución refleja las dinámicas descritas, y por qué cada decisión de diseño es como es.
...
## Argumentación — Título I: Principios Fundamentales
...
## Argumentación — Título II: Sistema Electoral

### Artículo 10: Distritos Uninominales {.unnumbered}
...
### Artículo 13: Doble Vuelta Electoral {.unnumbered}
...
### Artículo 14: Tamaño de Distritos y AOCD {.unnumbered}
...
### Artículo 15: Ciclo de 21 años {.unnumbered}
...
## Argumentación — Título III: Proceso de Transición
...
### Artículo 19: Proceso de Arranque {.unnumbered}
...
## Argumentación — Título IV: Separación y Contrapesos
...
## Argumentación — Título V: Reforma y Protección
...
### Artículo 70: Los mecanismos prevalecen sobre los derechos {.unnumbered}
...
### Artículo 68: Reforma ordinaria y protección contra bypass {.unnumbered}
...
## Saber más {.unnumbered}

### Teoría política

- **Antonio García Trevijano** — *Teoría Pura de la República* (2010). La base teórica de los distritos uninominales, la doble vuelta, la revocabilidad directa y la autodestrucción mutua entre poderes. Lectura esencial para entender el marco estructural de esta Constitución.

- **Robert Michels** — *Los Partidos Políticos: Un Estudio Sociológico de las Tendencias Oligárquicas de la Democracia Moderna* (*Zur Soziologie des Parteiwesens in der modernen Demokratie*, 1911). La Ley de Hierro de las Oligarquías: toda organización, por democrática que sea en su origen, tiende inevitablemente a concentrar el poder en una élite. Esta Constitución se diseña explícitamente contra esa tendencia.

### Ingeniería de sistemas y seguridad

- **[Tolerancia a fallos bizantinos](https://en.wikipedia.org/wiki/Byzantine_fault)** — El problema fundamental de los sistemas distribuidos donde algunos participantes pueden ser maliciosos. La mentalidad de diseño de esta Constitución — asumir que algunos actores serán deshonestos y diseñar para que el sistema funcione a pesar de ello — proviene directamente de este campo.
